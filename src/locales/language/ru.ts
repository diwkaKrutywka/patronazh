export default {
  ...
  report_hint_select_filter: "Выберите способ фильтрации дат (месяц/год или диапазон)",
  ...
  report_pkg_universal_desc: "Сводные отчёты по всем случаям за выбранный период.",
  report_nurse_diary_title: "Ежедневник патронажной сестры",
  report_nurse_diary_desc: "Ежедневник по выполнению плана универсальных посещений.",
